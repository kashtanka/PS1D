...
!       endif
     ...
     :     f10.2,f15.3,f10.5,f10.2,f10.3)') !,2f10.6,f10.3,f9.3,f11.7,f10.1)')
!-----------1,2,3,4--------------------------!
...
!-----------21,22,23,24,25,26------------------------!
     : wqt_h,Tsi,(z(1)-z_sl)/dzits,-tst_s2*ust_s2,th2m,LW
     ...
     : mqci*1000.,mqsn*1000.
       ...
       !-----------writing profiles---------------------------!
       if(mod(nstep*dt,8*3600.).eq.0)then
     ...
     :                  qsat(t(iz-1),p(iz-1,2)))/(z(iz+1)-z(iz-1))
           ...
           write(20,'(f7.2,5f10.4,f10.6,2f14.5,f20.4,f12.6,2f12.5,3f15.9,
     :              f12.6,f12.4)')
